...
import { Button } from '@mui/material';
import Box from '@mui/material/Box';
import { testConnection as testConnectionAPI } from '../api/FoodProductsAPI';
...
export default function Homepage() {
  ...
  return (
    <Container>
      <br/>
      <Button onClick={testBackendConnection} variant="outlined" className="test-btn">Test Backend Connection</Button>
      <br/>

      {testResult && <p>Backend Test Result: {testResult}</p>}
      <br />
      <Box className="segment-one">
        <div className="flex-segment">
          <div >
